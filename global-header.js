(function () {
  ...
  header.innerHTML = `
    ...
    <div class="icons" aria-label="Account shortcuts">
      ...
      <a class="mobile-header-action" href="builder-market.html#backpack" aria-label="View Builder Backpack">${icon('M8 8V6a4 4 0 018 0v2M6 8h12a2 2 0 012 2v10H4V10a2 2 0 012-2Z')}<span>Builder Backpack</span></a>
