(function (root, factory) {
  ...
  const MUZIKAZ_PAYMENT_NETWORKS = Object.freeze({
    ETH: Object.freeze({ symbol: 'ETH', name: 'Ethereum', network: 'Ethereum Mainnet', address: EVM_ADDRESS, type: 'evm', chainId: '0x1', decimals: 18, rateId: 'ethereum', uri: 'ethereum' }),
    POL: Object.freeze({ symbol: 'POL', name: 'Polygon', network: 'Polygon', address: EVM_ADDRESS, type: 'evm', chainId: '0x89', decimals: 18, rateId: 'polygon-ecosystem-token', uri: 'ethereum' }),
    BNB: Object.freeze({ symbol: 'BNB', name: 'BNB Smart Chain', network: 'BNB Smart Chain', address: EVM_ADDRESS, type: 'evm', chainId: '0x38', decimals: 18, rateId: 'binancecoin', uri: 'ethereum' }),
    SOL: Object.freeze({ symbol: 'SOL', name: 'Solana', network: 'Solana Mainnet', address: 'CZbaAbfZ97N9cocF221S3pyVP1isA59XTdciYspN27dA', type: 'solana', decimals: 9, rateId: 'solana', uri: 'solana' }),
