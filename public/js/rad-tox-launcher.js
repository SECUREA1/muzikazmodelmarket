...
(function () {
  ...
  function status(message) { var nodes = [document.getElementById('house-status')]; for (var i=0;i<nodes.length;i+=1) if(nodes[i]) nodes[i].textContent=message; }
