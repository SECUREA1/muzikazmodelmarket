(function () {
  ...
  window.MZKWallet = { symbol: 'MZK', MZK_PER_USD, MINIMUM_PURCHASE_USD, GAME_ENTRY_MZK, SWAP_BACK_RATE, LOCKED_LIQUIDITY_RATE, MINIMUM_SWAP_BACK_MZK, walletId, balance, history, record, spend, completeSwapBack, transfer, creditPurchase, starterLoadout, claimStarterLoadout, ensureWallet, mount, profile: activeProfile, connectedAddress, connectBrowserWallet, disconnectBrowserWallet, connectIdentity, setUsername, exportWallet, importWallet, downloadWallet };
})();
