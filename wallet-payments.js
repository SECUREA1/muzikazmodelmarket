(function () {
  ...
  function openWallet(q, walletName) { if (typeof window.open === 'function') window.open(q.uri, '_blank', 'noopener,noreferrer'); else window.location.assign(q.uri); return { opened: true, walletName, uri: q.uri }; }
