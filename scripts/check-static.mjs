...
for (const requiredLoadoutCopy of ['$30 USD · Live ETH quote', 'Minting is optional', 'Continue to Creator Tools', 'MZK Access Code', 'Open Account with Access Code', 'Connect Wallet to Validate', 'One account. One code. Any device.']) {
