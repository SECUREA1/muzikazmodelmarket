...
for (const vehicleControl of ['.builder-nearby-action[data-vehicle-active=true]', "builderActionButton.textContent=heldBuilderItem?'DROP ITEM':vehicleNearby?(vehicleController.active?'EXIT VEHICLE':'ENTER VEHICLE')"]) {
