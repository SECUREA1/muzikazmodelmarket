...
function corsHeaders(extra = {}) { return { 'Access-Control-Allow-Origin': process.env.MUZIKAZ_CORS_ORIGIN || 'https://muzikazmodelmarket.onrender.com', 'Access-Control-Allow-Methods': 'GET, POST, PATCH, DELETE, OPTIONS', 'Access-Control-Allow-Headers': 'Content-Type, Authorization, X-MUZIKAZ-Session, X-User-Id, X-User-Role, X-User-Name, X-Admin-Token, X-MUZIKAZ-Land-Asset', 'Cross-Origin-Resource-Policy': 'cross-origin', ...extra }; }
