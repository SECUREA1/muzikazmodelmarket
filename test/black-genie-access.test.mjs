...
test('Vibe Crib restores the member Loadout while keeping multiplayer controls available', async () => {
  ...
  assert.doesNotMatch(crib, /data-multiplayer-control disabled/);
